...
.adaptivecardWrapper > *:focus {
  outline: 1px solid var(--cc-primary-color-focus);
  border-color: var(--cc-primary-color-focus);
}

/* Button styles */
.adaptivecardWrapper :global(button) {
  appearance: none;
  background: var(--cc-black-10);
  border-radius: 10px;
  border: none;
  color: white;
  cursor: pointer;
...
.adaptivecardWrapper :global(textarea::-webkit-scrollbar-thumb) {
  ...
  border-radius: 10px;
  border: 12px solid var(--cc-white);
  border-block: none;
}
...
.adaptivecardWrapper :global(select:focus) {
  outline: 1px solid var(--cc-primary-color-focus);
  border-color: 1px solid var(--cc-primary-color-focus);
}
...
.adaptivecardWrapper :global([type='checkbox']) {
  ...
  border: 1px solid var(--cc-black-10, #999);
  border-radius: 1px;
  width: 16px;
  height: 16px;
}
...
.adaptivecardWrapper :global([type='checkbox']:checked) {
  background-color: var(--cc-black-10);
...
.adaptivecardWrapper :global([type='checkbox']:active) {
  background-color: var(--cc-black-60);
  border-color: var(--cc-black-60);
}

.adaptivecardWrapper :global([type='checkbox']:checked:hover) {
  background-color: var(--cc-black-40);
  border-color: var(--cc-black-40);
}
...
.adaptivecardWrapper :global(select option) {
  ...
  border-bottom: 1px solid var(--cc-black-10);
}
</style>
